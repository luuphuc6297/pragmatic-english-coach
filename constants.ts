...
export const FALLBACK_SCENARIOS: LessonContext[] = [
    {
        ...
        hints: { level1: 'Greeting after a long time.', level2: 'Long time no see, how...', level3: 'have you been' }
    },
    {
        id: 'fb2', 
        topic: 'food',
        ...
        hints: { level1: 'Polite request (I\'d like...).', level2: 'I\'d like an iced black coffee...', level3: 'less sugar' }
    },
    {
        id: 'fb3', 
        topic: 'travel',
        ...
        hints: { level1: 'Polite indirect question.', level2: 'Do you happen to know where...', level3: 'nearest / is' }
    }
];
