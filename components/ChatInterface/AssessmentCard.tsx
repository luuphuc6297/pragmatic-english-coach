...
import {ChatMessage, ChatMode, SavedItem} from '../../types';
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          onClick={() =>
                            onSaveItem({
                              id: Date.now().toString(),
                              original: (assessment.alternativeTones as any)[tone.key],
                              correction: (assessment.alternativeTones as any)[tone.key],
                              type: 'vocabulary',
                              context: (assessment.alternativeTones as any)[tone.key],
                              timestamp: Date.now(),
                              masteryScore: 0,
                            })
                          }
                        ...
                        <button
                          onClick={() =>
                            onPlayAudio(
                              msg.id,
                              (assessment.alternativeTones as any)[tone.key],
                              tone.key,
                            )
                          }
