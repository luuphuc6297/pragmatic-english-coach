...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  const handleGenerateVideo = async (msg: ChatMessage) => {
    ...
    const phraseToAct =
      msg.assessment.betterAlternative || msg.assessment.correction || msg.content;
          ...
          return (
            ...
            >
              ...
              >
                {/* Avatar */}
                <div
                  className={`flex-shrink-0 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center shadow-sm mt-1 ring-2 ring-white ${
                    msg.role === 'user'
